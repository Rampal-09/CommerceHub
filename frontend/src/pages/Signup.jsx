      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur-md border border-slate-200/80 rounded-2xl shadow-xl shadow-indigo-100/60 p-8 sm:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Join CommerceHub to get started today
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              <span className="absolute left-3.5 text-slate-400 text-base pointer-events-none">✉️</span>
              <input
                type="email"
                id="email"
                name="email"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="relative flex items-center justify-center gap-2 p-2.5 border rounded-xl cursor-pointer text-xs font-medium transition-all select-none">
                <input
                  type="radio"
                  name="role"
                  value="user"
                  ...
                  disabled={loading}
                />
                <span className="w-full text-center py-1 rounded-lg border border-slate-200 bg-slate-50 text-slate-600 peer-checked:bg-indigo-50 peer-checked:border-indigo-600 peer-checked:text-indigo-700 peer-checked:font-semibold transition-all">
                  👤 Customer
                </span>
              </label>
        ...
        <div className="text-center mt-6 text-xs text-slate-500">
          ...
          <a href="/login" className="text-indigo-600 hover:text-indigo-700 font-semibold underline-offset-2 hover:underline">
            Sign in
          </a>
        </div>
